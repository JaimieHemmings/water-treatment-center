...
const AccordionItem = ({ item }: AccordionItemProps) => {
  ...
  return (
    <div className="border-b border-selectiveyellow">
      ...
      >
        <h3 className="text-lg md:text-xl text-textblue max-w-[95%]">{item.question}</h3>
        <span 
          className="transform transition-transform duration-300 ease-in-out text-textblue"
      ...
      >
        <div className="p-4 max-w-[95%] text-textblue">
          {item.answer}
        </div>
      </div>
    </div>

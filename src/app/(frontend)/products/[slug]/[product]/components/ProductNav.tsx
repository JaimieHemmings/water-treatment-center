...
const ProductNav = () => {
  ...
  return (
    <div className="w-full bg-antiflashwhite p-3 text-jet shadow-[0px_4px_6px_0px_rgba(74,_144,_226,_0.4)] sticky top-[74px] md:top-[109px] left-0 hidden md:block z-50">
